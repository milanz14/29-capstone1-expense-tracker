...
t1 = Transaction(location='mcdonalds', amount=7.63, date=date.today(), category='dinner')
t2 = Transaction(location='foot locker', amount=65, date=date.today(), category='shopping')
t3 = Transaction(location='gym', amount=20, date=date.today(), category='health')
t4 = Transaction(location='sunoco', amount=26.81, date=date.today(), category='gas')
t5 = Transaction(location='cvs', amount=9.99, date=date.today(), category='pharmacy')
t6 = Transaction(location='amazon', amount=100, date=date.today(), category='shopping')
db.session.add(t1)
db.session.add(t2)
db.session.add(t3)
db.session.add(t4)
