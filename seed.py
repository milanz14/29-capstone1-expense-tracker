...
t1 = Transaction(location='mcdonalds', amount=7.63, date=date.today(), category='dinner', details='quick bite driving home')
...
t4 = Transaction(location='Esso', amount=26.81, date=date.today(), category='gas')
t5 = Transaction(location='shoppers', amount=9.99, date=date.today(), category='pharmacy', details='cough medicine')
