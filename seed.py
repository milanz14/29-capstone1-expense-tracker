...
t1 = Transaction(location='mcdonalds', amount=7.63, category='Dining Out', details='quick bite driving home')
t2 = Transaction(location='foot locker', amount=65.00, category='Shopping')
t3 = Transaction(location='gym', amount=20.00, category='Health', details='monthly fee')
t4 = Transaction(location='Esso', amount=26.81, category='Car Expenses')
t5 = Transaction(location='shoppers', amount=9.99, category='Health', details='cough medicine')
t6 = Transaction(location='amazon', amount=100.15, category='Shopping')
db.session.add(t1)
db.session.add(t2)
db.session.add(t3)
db.session.add(t4)
